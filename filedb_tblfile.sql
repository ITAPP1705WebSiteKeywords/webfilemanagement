...
--
-- Host: 127.0.0.1    Database: filedb
-- ------------------------------------------------------
...
CREATE TABLE `tblfile` (
  ...
  `FileKeywords` varchar(255) DEFAULT NULL,
  `FileCreated` datetime DEFAULT NULL,
  PRIMARY KEY (`FileID`),
  KEY `fk_idx` (`FileOwner`),
  CONSTRAINT `foreignkey` FOREIGN KEY (`FileOwner`) REFERENCES `tbluser` (`UserID`)
...
-- Dump completed on 2015-05-09 22:04:01
